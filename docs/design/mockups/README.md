...
| `vocabapp-playground.html` | L'APP ENTIÈRE navigable (v2) : shell 5 onglets, chemin du jour S18, sessions, clusters, test de niveau, menus — dataset minimal 1 langue, bloc CONFIG réglable | Both (page) · Light (écran) |
