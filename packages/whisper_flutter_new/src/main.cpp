...
json transcribe(json jsonBody) noexcept
{
    ...
    // run the inference
    {
        ...
        // for tiny, ~6s for base on a Galaxy S22 Ultra — field log
        // 2026-07-10). Shrink the encoder context to the actual clip
        // length (+ headroom) — the standard short-clip speedup on mobile.
        {
