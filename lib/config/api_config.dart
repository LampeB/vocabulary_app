class ApiConfig {
  ...
  // Clé API ElevenLabs (à remplacer par votre clé)
  ...
  // Clé API Claude (à remplacer par votre clé)
  ...
  static bool get canUseClaudeParsing => useClaudeForParsing && isClaudeConfigured;
}
