...
abstract final class AppTextStyles {
  ...
  /// V3 display face: titles, key numbers, and the primary word on a card.
  ...
  /// V3 Korean display face for a Hangul word on a full study card.
  static TextStyle koreanSerif(
    double size,
    FontWeight weight, {
    double? height,
    Color? color,
